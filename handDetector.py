...
class handModule:
    def __init__(self, mode=False, valueHands=1, complexity_model=1, detection=0.5, track=0.5):
        self.mode = mode
        self.complexity_model = complexity_model
        self.valueHands = valueHands
        self.detection = detection
        self.track = track
        

        self.mpHands = mp.solutions.hands
        self.hands = self.mpHands.Hands(int(self.mode), int(self.valueHands), int(self.detection), int(self.track))
